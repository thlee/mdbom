...
Mac과 Windows 모두 공통 떠 있는 도구 패널을 사용합니다. 파일명은 창 제목에, 상태·확대/축소는 하단에 표시합니다. 문서·소스·좌우·상하 보기, 스크롤 연결, 본문 폭, 테마, 전체화면 및 도구 고정/자동 숨김을 지원합니다. 자세한 동작은 [공통 사용법](../README.ko.md#보기와-도구-패널)을 참고하세요.
